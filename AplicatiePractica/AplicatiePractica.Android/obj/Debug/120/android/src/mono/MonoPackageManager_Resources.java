...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AplicatiePractica.Android.dll" comes first in this list. */
		"AplicatiePractica.Android.dll",
		"AplicatiePractica.DB.dll",
		"AplicatiePractica.dll",
		"FFImageLoading.dll",
